const String kSheepPhoto = 'assets/images/sheep.jpeg';
...
const String kAreaID = 'areaID';

const String kMeatCollectionName = 'meats';
const String kMeatType = 'meatType';
const String kMeatID = 'meatID';
...
const String kOrderID = 'orderID';
const String kAvailableMeatID = 'availableMeatID';
const String kOrderAddress = 'orderAddress';
const String kOrderTime = 'orderTime';
const String kOrderTotalPrice = 'orderTotalPrice';

const String kAvailableMeatsCollectionName = 'availableMeats';
const String kAvailableMeatIDd = 'availableMeatID';
